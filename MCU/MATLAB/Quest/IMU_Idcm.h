...
struct Parameters_IMU_Idcm_ {
  ...
  real_T UnitDelay_X0;                 /* Expression: 1
                                        ...
                                        */
  real_T delta_Value[4];               /* Expression: [0.0099; 0.0099; 0.0099; 0.0099]
...
extern struct RT_MODEL_IMU_Idcm *IMU_Idcm_M;
 ...
 *
 * '<Root>' : IMU_Idcm
 * '<S1>'   : IMU_Idcm/QUEST Filter
 * '<S2>'   : IMU_Idcm/Quaternions to Euler Angles
 * '<S3>'   : IMU_Idcm/QUEST Filter/QUEST filter
 * '<S4>'   : IMU_Idcm/Quaternions to Euler Angles/Quaternion Normalize
 * '<S5>'   : IMU_Idcm/Quaternions to Euler Angles/Subsystem
 * '<S6>'   : IMU_Idcm/Quaternions to Euler Angles/Subsystem1
 * '<S7>'   : IMU_Idcm/Quaternions to Euler Angles/Subsystem2
 * '<S8>'   : IMU_Idcm/Quaternions to Euler Angles/Subsystem3
 * '<S9>'   : IMU_Idcm/Quaternions to Euler Angles/Subsystem4
 * '<S10>'  : IMU_Idcm/Quaternions to Euler Angles/Quaternion Normalize/Quaternion Modulus
 * '<S11>'  : IMU_Idcm/Quaternions to Euler Angles/Quaternion Normalize/Quaternion Modulus/Quaternion Norm
 */
